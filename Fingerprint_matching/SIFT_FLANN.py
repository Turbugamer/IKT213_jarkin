...
class SIFT_FLANN_Matcher:
    ...
    def match_fingerprints(self, img1_path, img2_path):
        img1 = self.preprocess_fingerprint(img1_path)
        img2 = self.preprocess_fingerprint(img2_path)
    ...
    def process_dataset(self, dataset_path, results_folder):
        ...
        for folder in sorted(os.listdir(dataset_path)):
            ...
            if os.path.isdir(folder_path):  # Check if it's a valid directory
                ...
                match_count, match_img =self.match_fingerprints(img1_path, img2_path)
